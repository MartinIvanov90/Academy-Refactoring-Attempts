...
namespace Academy.Core.Providers
{
    public class CommandParser : IParser
    {
        ...
        public ICommand ParseCommand(string fullCommand)
        {
            ...
            return commandFactory.ReturnCommand(commandName);
        }

        // Magic, do not touch!
        //public ICommand ParseCommand(string fullCommand,IEngine engine)
        //{
        //    var commandName = fullCommand.Split(' ')[0];
        //    var commandTypeInfo = this.FindCommand(commandName);
        //    var command = Activator.CreateInstance(commandTypeInfo, AcademyFactory.Instance, engine) as ICommand;
